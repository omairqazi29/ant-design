	  ...
	  "content": [
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          " that Popconfirm is not working. ",
	          [
	            "a",
	            {
	              "title": null,
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          "p",
	          "Added a Third-Party Library Page for recommending other greet react components. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fixed misplaced Sider of Layout. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fixed Input.Search wrong block layout and misplaced icon. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Added a customize Collapse panel demo. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fixed not-available pagination issue when property ",
	              [
	                "code",
	                "pagination"
	              ],
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fixed that three level filter menu is not working. ",
	              [
	                "a",
	                {
	                  "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Added warnings when non-BreadcrumbItem node is nested under Breadcrumb. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Make TreeSelect panel default height smaller than screen height. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Replaced arrows of DatePicker year panel by year text. ",
	          [
	            "a",
	            {
	              "title": null,
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix style problem for Menu dark theme. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix style problem in DatePicker year panel. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix that Table loading doesn't mask Pagination. ",
	          [
	            "a",
	            {
	              "title": null,
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            [
	              "p",
	              "InputGroup support compact display mode. ",
	              [
	                "a",
	                {
	                  "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix the dislocation problem of Pagination in low resolution. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix wrapping display of Dropdown.Button. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix wrong background color of Cascader in disabled status. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          " doesn't work, and some documentation errors. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix the extra border of ButtonGroup. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix wrong background color of the Submenu(horizontal mode). ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix overlapping graphics with Select/Cascader in Form.Item with hasFeedback. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Reset border-radius of the first row in Table without header. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Improve the drag performance of Tree. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Update rc-form to support nested style of getFieldDecorator",
	          "[id]",
	          "."
	        ]
	      ]
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix style issue resulting in nested Tabs. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          " callback issue resulting in Radio. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix background issue resulting in selected element of veritcal Menu.",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Improve first argument type of ",
	          [
	            "code",
	            "onChange"
	          ],
	          " callback of Cascader.",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Improve default width of Datepicker",
	          "[showtime]",
	          ". ",
	          [
	            "a",
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix issue resulting in there is a redundant shadow between ",
	          [
	            "code",
	            "disabled"
	          ],
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix error when setting Momment ",
	          [
	            "code",
	            "defaultValue"
	          ],
	          ...
	          " on RangePicker, TimePicker, Calendar. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix issue resulting in Affix disappears when it's uesed in animated Tabs. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          " when manually selecting and selecting by search. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix issue resulting in Tabs get offset, when too many tabs are opening. ",
	          [
	            "a",
	            {
	              "title": null,
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          "p",
	          "ToolTip, Popover, Popconfirm support to wrap text node and multiple node directly now. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix current position bug when scroll fastly. ",
	              [
	                "a",
	                {
	                  "title": null,
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix a bug of parent component ref node is undefined. ",
	              [
	                "a",
	                {
	                  "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix a selection problem when setting defaultChecked in rowSelection. ",
	              [
	                "a",
	                {
	                  "title": null,
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix grouping column title cannot work with filters. ",
	              [
	                "a",
	                {
	                  "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix TimePicker can not override width by ",
	          [
	            "code",
	            "style.width"
	          ],
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          " to test the structure of components and SSR issues."
	        ]
	      ],
	      [
	        "li",
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            [
	              "p",
	              "DatePicker can determine whether to show \"Today\" button. ",
	              [
	                "a",
	                {
	                  "title": null,
	          ...
	          [
	            ...
	            [
	              "p",
	              "RangePicker can set presetted ranges. ",
	              [
	                "a",
	                {
	                  "title": null,
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix \"Now\" button doesn't work while ",
	              [
	                "code",
	                "DatePicker[showTime]"
	              ],
	      ...
	      [
	        ...
	        [
	          "p",
	          "Mention onSelect event will get complete record. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Pagination can get current range. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            [
	              "p",
	              "Can listen the click event of table cell. ",
	              [
	                "a",
	                {
	                  "title": null,
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix issue with selected status. ",
	              [
	                "a",
	                {
	                  "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix alignment of multi-line Checkbox. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix alignment of InputNumber while using with other form controls. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix that Popover should support Checkbox and Radio as children. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix that Transfer doesn't show \"Not Found\" while there is no search result. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix style of placeholder of TreeSelect. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix compile errors in TypeScript. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix that feedback icon should not affect users' operation. ",
	          [
	            "a",
	            {
	              "title": null,
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          " about querySelector, and make some experience Optimization .",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            "https://github.com/ant-design/ant-design/issues/3729"
	          ],
	          ")"
	        ]
	      ],
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          " to allow render some addon to its bottom."
	        ]
	      ],
	      [
	        "li",
	      ...
	      [
	        ...
	        [
	          ...
	          " style when it's disabled and mouse hovered. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix issue resulting in server side render ",
	          [
	            "code",
	            "Transfer"
	          ],
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix issue resulting in preview image not display when ",
	          [
	            "code",
	            "Upload"
	          ],
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            [
	              "p",
	              "Improve number over 99 displaying when mouse hovering. ",
	              [
	                "a",
	                {
	                  "title": null,
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix moving animation when using ",
	              [
	                "code",
	                "Badge"
	              ],
	        ...
	        [
	          ...
	          [
	            ...
	            [
	              ...
	              " to support automatic tokenization. ",
	              [
	                "a",
	                {
	                  "title": null,
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix issue resulting in Select can't display correct selected item text in ",
	              [
	                "code",
	                "combobox"
	              ],
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          "p",
	          "Not rely on specific version of React now. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "DatePicker & MonthPicker & RangePicker allow developers to set whether to show the clear button. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          " for nested form control automatically. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Improve the TypeScript definition of Card & DatePicker & Icon & Table. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix the alignment of Button & Input & DatePicker & Select. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix loading status animation for message.",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix style issue for search button in Form.Item. ",
	              [
	                "a",
	                {
	                  "title": null,
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix Form.Item should not treat no user input as validate success. ",
	              [
	                "a",
	                {
	                  "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix style of fixed header of Table while ",
	              [
	                "code",
	                "dataSource"
	              ],
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix Table will overlap SubMenu while ",
	              [
	                "code",
	                "dataSource"
	              ],
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix height of TabPane should follow height of its content. ",
	              [
	                "a",
	                {
	                  "title": null,
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix errors while render Affix and BackTop on server. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix conflicts between Cascader search mode and browser's autocomplete behaviour. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix differences between overlay's and trigger's date format. ",
	              [
	                "a",
	                {
	                  "title": null,
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix style conflicts with TimePicker. ",
	              [
	                "a",
	                {
	                  "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix infinite loop while inc/dec InputNubmer with keyboard. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            [
	              "p",
	              "Fix the unstable width of table cell with Select",
	              "[showsearch]",
	              ". ",
	              [
	                "a",
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix that the height of TabPane doesn't follow height of content. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          "Fix bug Transfer",
	          "[titles]",
	          " is not under the control of LocaleProvider. ",
	          [
	            "a",
	            {
	              "title": null,
	        ...
	        [
	          ...
	          [
	            ...
	            [
	              ...
	              " will override default behaviour. ",
	              [
	                "a",
	                {
	                  "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix bug that moment locales is not found while built. ",
	          [
	            "a",
	            {
	              "title": null,
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix developers cannot call methods of react-slick. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          "Fix Steps.Step",
	          "[icon]",
	          " should support React.ReactNode. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix server-side render for Affix. ",
	          [
	            "a",
	            {
	              "title": null,
	    ...
	    [
	      ...
	      " is published. We had refactored code and improve functionalities and details of existing components. What's more, we provide English version of the documentation. The antd community help us a lot in developing ",
	      [
	        "code",
	        "antd@2.0.0"
	      ],
	    ...
	    [
	      "p",
	      "If you meet any problem while you try to upgrade from ",
	      [
	        "code",
	        "antd@1.0.0"
	      ],
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            " files which are officially supported"
	          ],
	          ". Thanks to all the developers that contributed to ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          ", and we are going to provide both of Chinese and English versions of the documentation in the future. Thanks to all the translators and reviewers that contributed to ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "DatePicker, TimePicker, Calendar and other components that are designed to select time ",
	          [
	            "strong",
	            "are refactored to replace ",
	            [
	              "a",
	              {
	                "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          " of Form is replaced with ",
	          [
	            "code",
	            "getFieldDecorator"
	          ],
	          " which will warn developers if they make mistakes. Related discussion ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          ", such as QueueAnim, Validation, Form.ValueMixin, Progress.Line, Progress.Circle, Popover",
	          "[overlay]",
	          " and Slider",
	          "[marks]",
	          " will not support array any more."
	        ]
	      ]
	    ],
	    [
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          " of all the time-related components will not support type ",
	          [
	            "code",
	            "String/Date"
	          ],
	      ...
	      [
	        ...
	        [
	          ...
	          ", plus other callback functions had been changed to type moment. Please consult ",
	          [
	            "a",
	            {
	              "title": null,
	          ...
	          ", and update your code accordingly. And you can consult this ",
	          [
	            "a",
	            {
	              "title": null,
	        ...
	        [
	          ...
	          " will lost time zone, we should use ",
	          [
	            "code",
	            ".format"
	          ],
	          " to convert date to string first, see related issue ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          " of time-related components is changed from ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          ...
	          " of Breadcrumb are removed, please use ",
	          [
	            "code",
	            "itemRender"
	          ],
	      ...
	      [
	        ...
	        [
	          ...
	          " of Menu are removed, please use ",
	          [
	            "code",
	            "onOpenChange"
	          ],
	          ". As being totally different, please check ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Paging columns of Table were removed, please use ",
	          [
	            "a",
	            {
	              "title": null,
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          " of Form is deprecated, please use ",
	          [
	            "code",
	            "getFieldDecorator"
	          ],
	      ...
	      [
	        ...
	        [
	          ...
	          " of DatePicker is deprecated, please use ",
	          [
	            "code",
	            "onOpenChange"
	          ],
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix slow response of expanding sub menu in Menu",
	          "[inline]",
	          " mode. ",
	          [
	            "a",
	      ...
	      [
	        ...
	        [
	          "p",
	          "The button of Modal.confirm(and so on) should not be clickable while it is closed asynchronously. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Tree.Node should not show arrow if it has no child nodes. ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "Fix cursor style of arrows that are hidden of Tree.Node. ",
	          [
	            "a",
	            {
	              "title": null,
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            "customized tips and animation work together"
	          ],
	          ". @jerrybendy"
	        ]
	      ],
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            "whether an option is checkable"
	          ],
	          "."
	        ]
	      ],
	      ...
	      [
	        ...
	        [
	          "p",
	          "Improve the status changed animation of ",
	          [
	            "a",
	            {
	              "title": null,
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          " a collection of Axure files which includes components and patterns that follow Ant Design Specification."
	        ]
	      ],
	      [
	        "li",
	        [
	          ...
	          " becomes an common load-on-demand solution and not just for ",
	          [
	            "code",
	            "antd"
	          ],
	      ...
	      [
	        ...
	        [
	          ...
	          " is published and it is officially recommended framework ",
	          [
	            "a",
	            {
	              "title": null,
	      ...
	      [
	        ...
	        [
	          "p",
	          "The officially recommended scaffold is ",
	          [
	            "a",
	            {
	              "title": null,
