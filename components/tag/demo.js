...
/***/ function(module, exports, __webpack_require__) {
	...
	var _style4 = __webpack_require__(184);
	  ...
	  "preview": function jsonmlReactLoader() {
	    ...
	    var EditableTagGroup = function (_React$Component) {
	      ...
	      function EditableTagGroup() {
	        ...
	        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = { tags: [{ key: 1, name: 'Unremovable' }, { key: 2, name: 'Tag 2' }, {
	            key: 3, name: 'Tag 3' }] }, _this.handleClose = function (key) {
	          var tags = [].concat((0, _toConsumableArray3.default)(_this.state.tags)).filter(function (tag) {
	            return tag.key !== key && tag;
	          });console.log(tags);_this.setState({ tags: tags });
	        }, _this.addTag = function () {
	          index += 1;var tags = [].concat((0, _toConsumableArray3.default)(_this.state.tags), [{ key: index, name: 'New tag ' + index }]);console.log(tags);_this.setState({ tags: tags });
	        }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
	      }
	      ...
	      EditableTagGroup.prototype.render = function render() {
	        ...
	        return _react2.default.createElement(
	          ...
	          tags.map(function (tag) {
	            return _react2.default.createElement(
	              _tag2.default,
	              { key: tag.key, closable: tag.key !== 1, afterClose: function afterClose() {
	                  return _this2.handleClose(tag.key);
	                } },
	              tag.name
	            );
	          }),
	          _react2.default.createElement(
	            _button2.default,
	            { size: 'small', type: 'dashed', onClick: this.addTag },
	            '+ New tag'
	          )
	        );
	      };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    'basic': __webpack_require__(955),
	    'checkable': __webpack_require__(956),
	    'colorful': __webpack_require__(957),
	    'control': __webpack_require__(958),
	    'hot-tags': __webpack_require__(959),
	}
