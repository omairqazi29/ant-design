...
module.exports = {
    'basic-controlled': __webpack_require__(2496),
    'basic': __webpack_require__(2497),
    'customized-icon': __webpack_require__(2498),
    'directory': __webpack_require__(2499),
    'draggable': __webpack_require__(2500),
    'dynamic': __webpack_require__(2501),
    'line': __webpack_require__(2502),
    'search': __webpack_require__(2503),
}
...
module.exports = {
  ...
  var Demo = function (_React$Component) {
    ...
    function Demo() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Demo.__proto__ || Object.getPrototypeOf(Demo)).call.apply(_ref, [this].concat(args))), _this), _this.onSelect = function () {
  ...
  var Demo = function (_React$Component) {
    ...
    function Demo() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Demo.__proto__ || Object.getPrototypeOf(Demo)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        var data = [].concat(_toConsumableArray(_this.state.gData)); // Find dragObject
