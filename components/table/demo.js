...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    'ajax': __webpack_require__(1652),
	    'basic': __webpack_require__(1653),
	    'bordered': __webpack_require__(1654),
	    'colspan-rowspan': __webpack_require__(1655),
	    'custom-filter-panel': __webpack_require__(1656),
	    'dynamic-settings': __webpack_require__(1657),
	    'edit-cell': __webpack_require__(1658),
	    'edit-row': __webpack_require__(1659),
	    'expand-children': __webpack_require__(1660),
	    'expand': __webpack_require__(1661),
	    'fixed-columns-header': __webpack_require__(1662),
	    'fixed-columns': __webpack_require__(1663),
	    'fixed-header': __webpack_require__(1664),
	    'grouping-columns': __webpack_require__(1665),
	    'head': __webpack_require__(1666),
	    'jsx': __webpack_require__(1667),
	    'paging': __webpack_require__(1668),
	    'reset-filter': __webpack_require__(1669),
	    'row-selection-and-operation': __webpack_require__(1670),
	    'row-selection': __webpack_require__(1671),
	    'size': __webpack_require__(1672),
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _style2 = __webpack_require__(36);
	...
	var _reqwest = __webpack_require__(1032);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _style3 = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _style8 = __webpack_require__(68);
	...
	module.exports = {
	  ...
	  "preview": function jsonmlReactLoader() {
	    ...
	    };var showHeader = true;var footer = function footer() {
	    ...
	    var Demo = function (_React$Component) {
	      ...
	      function Demo() {
	        ...
	        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = { bordered: false, loading: false, pagination: true, size: 'default', expandedRowRender: expandedRowRender, title: title, showHeader: showHeader, footer: footer, rowSelection: {}, scroll: undefined }, _this.handleToggle = function (prop) {
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                FormItem,
	                { label: 'Column Header' },
	                _react2.default.createElement(_switch2.default, { checked: !!state.showHeader, onChange: this.handleHeaderChange })
	              ),
	              _react2.default.createElement(
	                FormItem,
	                { label: 'Footer' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  "preview": function jsonmlReactLoader() {
	    var columns = [{ title: 'Name', dataIndex: 'name', key: 'name', width: '40%' }, { title: 'Age', dataIndex: 'age', key: 'age', width: '30%' }, { title: 'Address', dataIndex: 'address', key: 'address' }];var data = [{ key: 1, name: 'John Brown sr.', age: 60,
	      address: 'New York No. 1 Lake Park', children: [{ key: 11, name: 'John Brown', age: 42,
	        address: 'New York No. 2 Lake Park' }, { key: 12,
	        name: 'John Brown jr.', age: 30, address: 'New York No. 3 Lake Park',
	        children: [{ key: 121, name: 'Jimmy Brown', age: 16, address: 'New York No. 3 Lake Park' }] }, { key: 13, name: 'Jim Green sr.', age: 72, address: 'London No. 1 Lake Park', children: [{ key: 131, name: 'Jim Green', age: 42, address: 'London No. 2 Lake Park', children: [{ key: 1311, name: 'Jim Green jr.', age: 25, address: 'London No. 3 Lake Park' }, { key: 1312, name: 'Jimmy Green sr.', age: 18,
	            address: 'London No. 4 Lake Park' }] }] }] }, { key: 2, name: 'Joe Black', age: 32,
	      address: 'Sidney No. 1 Lake Park' }]; // rowSelection objects indicates the need for row selection
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  "content": {
	    "zh-CN": [["p", "使用 JSX 风格的 API（2.5.0 以后引入）"], ["blockquote", ["p", "这个只是一个描述 ", ["code", "columns"], " 的语法糖，所以你不能用其他组件去包裹 ", ["code", "Column"], " 和 ", ["code", "ColumnGroup"], "。"]]],
	    "en-US": [["p", "Using JSX style API (introduced in 2.5.0)"], ["blockquote", ["p", "Since this is just a syntax sugar for the prop ", ["code", "columns"], ", so that you can't compose ", ["code", "Column"], " and ", ["code", "ColumnGroup"], " with other Components."]]]
	  },
	  "meta": {
	    "order": 1,
	    "title": {
	  ...
	  "preview": function jsonmlReactLoader() {
	    ...
	    var data = [{ key: '1', firstName: 'John', lastName: 'Brown',
	      age: 32, address: 'New York No. 1 Lake Park' }, {
	      key: '2', firstName: 'Jim', lastName: 'Green', age: 42, address: 'London No. 1 Lake Park' }, { key: '3', firstName: 'Joe', lastName: 'Black',
	      age: 32, address: 'Sidney No. 1 Lake Park' }];return _react2.default.createElement(
	      _table2.default,
	      { dataSource: data },
	      _react2.default.createElement(
	        ColumnGroup,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  "content": {
	    "zh-CN": [["p", "表格中的分页器可以通过一个配置对象来配置，当 ", ["code", "pagination={false}"], " 时，会隐藏分页器。"]],
	    "en-US": [["p", "The pagination in table could be configured with an object, and you can use ", ["code", "pagination={false}"], " to turn off pagination."]]
	  },
	  "meta": {
	    "order": 6,
	    "title": {
	  ...
	  "preview": function jsonmlReactLoader() {
	    var columns = [{ title: 'Name', dataIndex: 'name', render: function render(text) {
	      ...
	      } }, { title: 'Age', dataIndex: 'age' }, { title: 'Address', dataIndex: 'address' }];var data = [];
	    for (var i = 0; i < 46; i++) {
	      data.push({ key: i, name: 'Edward King ' + i, age: 32, address: 'London, Park Lane no. ' + i });
	    }var pagination = { total: data.length, showSizeChanger: true, onShowSizeChange: function onShowSizeChange(current, pageSize) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  "content": {
	    "zh-CN": [["p", "使用受控属性对筛选和排序状态进行控制。"], ["blockquote", ["ol", ["li", ["p", "columns 中定义了 filteredValue 和 sortOrder 属性即视为受控模式。"]], ["li", ["p", "只支持同时对一列进行排序，请保证只有一列的 sortOrder 属性是生效的。"]], ["li", ["p", "务必指定 ", ["code", "column.key"], "。"]]]]],
	    "en-US": [["p", "Control filters and sorters by ", ["code", "filteredValue"], " and ", ["code", "sortOrder"], "."], ["blockquote", ["ol", ["li", ["p", "Defining ", ["code", "filteredValue"], " or ", ["code", "sortOrder"], " means that it is in the controlled mode."]], ["li", ["p", "Make sure ", ["code", "sortOrder"], " is assigned for only one column."]], ["li", ["p", ["code", "column.key"], " is required."]]]]]
	  },
	  "meta": {
	    "order": 7,
	    "title": {
	  ...
	  "preview": function jsonmlReactLoader() {
	    var data = [{ key: '1', name: 'John Brown', age: 32, address: 'New York No. 1 Lake Park'
	      ...
	      setAgeSort: function setAgeSort() {
	        this.setState({ sortedInfo: { order: 'descend', columnKey: 'age' } });
	      },
	      render: function render() {
	        var _state = this.state,
	            sortedInfo = _state.sortedInfo,
	            filteredInfo = _state.filteredInfo;
	        sortedInfo = sortedInfo || {};filteredInfo = filteredInfo || {};var columns = [{ title: 'Name',
	          dataIndex: 'name',
	          key: 'name', filters: [{ text: 'Joe',
	            value: 'Joe' }, { text: 'Jim', value: 'Jim' }],
	          filteredValue: filteredInfo.name || null, onFilter: function onFilter(value, record) {
	          ...
	          sorter: function sorter(a, b) {
	            ...
	            return a.age - b.age;
	          }, sortOrder: sortedInfo.columnKey === 'age' && sortedInfo.order }, { title: 'Address', dataIndex: 'address', key: 'address', filters: [{ text: 'London', value: 'London' }, { text: 'New York', value: 'New York' }], filteredValue: filteredInfo.address || null, onFilter: function onFilter(value, record) {
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _button2.default,
	              { type: 'ghost', onClick: this.setAgeSort },
	              'Sort age'
	            ),
	            _react2.default.createElement(
	              _button2.default,
	              { type: 'ghost', onClick: this.clearFilters },
	              'Clear filters'
	            ),
	            _react2.default.createElement(
	              _button2.default,
	              { type: 'ghost', onClick: this.clearAll },
