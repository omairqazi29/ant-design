	...
	module.exports = {
	  ...
	  "preview": function jsonmlReactLoader() {
	    var columns = [{ title: 'Name', dataIndex: 'name', key: 'name', render: function render(text) {
	      ...
	      key: '1', name: 'John Brown', age: 32, address: 'New York No. 1 Lake Park' }, { key: '2', name: 'Jim Green', age: 42, address: 'London No. 1 Lake Park' }, { key: '3', name: 'Joe Black', age: 32, address: 'Sidney No. 1 Lake Park' }];return _react2.default.createElement(_table2.default, { columns: columns, dataSource: data });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _style8 = __webpack_require__(135);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    'ajax': __webpack_require__(919),
	    'basic': __webpack_require__(920),
	    'bordered': __webpack_require__(921),
	    'colspan-rowspan': __webpack_require__(922),
	    'custom-filter-panel': __webpack_require__(923),
	    'dynamic-settings': __webpack_require__(924),
	    'edit-cell': __webpack_require__(925),
	    'edit-row': __webpack_require__(926),
	    'expand-children': __webpack_require__(927),
	    'expand': __webpack_require__(928),
	    'fixed-columns-header': __webpack_require__(929),
	    'fixed-columns': __webpack_require__(930),
	    'fixed-header': __webpack_require__(931),
	    'grouping-columns': __webpack_require__(932),
	    'head': __webpack_require__(933),
	    'jsx': __webpack_require__(934),
	    'paging': __webpack_require__(935),
	    'reset-filter': __webpack_require__(936),
	    'row-selection-and-operation': __webpack_require__(937),
	    'row-selection': __webpack_require__(938),
	    'size': __webpack_require__(939),
	}
