...
/***/ function(module, exports) {
	...
	module.exports = {
	  "content": [
	    ...
	    [
	      "p",
	      "If it will take a long time to complete the operation, you can use ",
	      [
	        "code",
	        "Progress"
	      ],
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            "td",
	            "determine whether to display the progress value and the status icon"
	          ],
	          [
	            "td",
	            "boolean"
