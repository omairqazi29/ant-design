...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  "content": ["section", ["p", "展示操作的当前进度。"], ["h2", "何时使用"], ["p", "在操作需要较长时间才能完成时，为用户显示该操作的当前进度和状态。"], ["ul", ["li", ["p", "当一个操作会打断当前界面，或者需要在后台运行，且耗时可能超过2秒时；"]], ["li", ["p", "当需要显示一个操作完成的百分比时。"]]]],
	  "meta": {
	    "category": "Components",
	    "subtitle": "进度条",
	    "type": "Feedback",
