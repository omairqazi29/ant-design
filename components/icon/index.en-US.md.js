...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  "content": [
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            "code",
	            "[icon's name]-[shape, optional]-[Scanning line or not]-[direction, optional]"
	          ],
	          "."
	        ]
	      ]
	    ...
	    [
	      "p",
	      "By default, icon components uses ",
	      [
	        "a",
	        {
	          "title": null,
	      ...
	      ", publicly available repository of a huge set of icons. In case you need to use a locally deployed version of the icon font, you can refer to ",
	      [
	        "a",
	        {
	          "title": null,
	  ...
	  var _IconSet = __webpack_require__(69);
