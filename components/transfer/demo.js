	  ...
	  "preview": function jsonmlReactLoader() {
	    ...
	    for (var i = 0; i < 20; i++) {
	      ...
	      handleSelectChange: function handleSelectChange(sourceSelectedKeys, targetSelectedKeys) {
	        this.setState({ selectedKeys: [].concat((0, _toConsumableArray3.default)(sourceSelectedKeys), (0, _toConsumableArray3.default)(targetSelectedKeys)) });console.log('sourceSelectedKeys: ', sourceSelectedKeys);console.log('targetSelectedKeys: ', targetSelectedKeys);
	      },
	      render: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    'advanced': __webpack_require__(966),
	    'basic': __webpack_require__(967),
	    'custom-item': __webpack_require__(968),
	    'large-data': __webpack_require__(969),
	    'search': __webpack_require__(970),
	}
