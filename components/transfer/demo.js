	  ...
	  "preview": function jsonmlReactLoader() {
	    ...
	    for (var i = 0; i < 20; i++) {
	      ...
	      render: function render() {
	        ...
	        return _react2.default.createElement(_transfer2.default, { dataSource: mockData, titles: ['Source', 'Target'], targetKeys: state.targetKeys, selectedKeys: state.selectedKeys, onChange: this.handleChange, onSelectChange: this.handleSelectChange, render: function render(item) {
	            return item.title;
	          } });
	      }
	    });return _react2.default.createElement(App, null);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    'advanced': __webpack_require__(982),
	    'basic': __webpack_require__(983),
	    'custom-item': __webpack_require__(984),
	    'large-data': __webpack_require__(985),
	    'search': __webpack_require__(986),
	}
