...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  }, "jQuery-File-Upload"], " about how to implement server side upload interface."]], ["table", ["thead", ["tr", ["th", "Property"], ["th", "Description"], ["th", "Type"], ["th", "Default"]]], ["tbody", ["tr", ["td", "name"], ["td", "The name of uploading file"], ["td", "String"], ["td", "'file'"]], ["tr", ["td", "defaultFileList"], ["td", "Default list of files that have been uploaded."], ["td", "Array", "[object]"], ["td", "-"]], ["tr", ["td", "fileList"], ["td", "List of files that have been uploaded (controlled). Here is a common issue ", ["a", {
	    "title": null,
	    "href": "https://github.com/ant-design/ant-design/issues/2423"
	  }, "#2423"], " when using it"], ["td", "Array", "[object]"], ["td", "-"]], ["tr", ["td", "action"], ["td", "Required. Uploading URL"], ["td", "String"], ["td", "-"]], ["tr", ["td", "data"], ["td", "Uploading params or function which can return uploading params."], ["td", "Object or function(file)"], ["td", "-"]], ["tr", ["td", "headers"], ["td", "Set request headers, valid above IE10."], ["td", "Object"], ["td", "-"]], ["tr", ["td", "showUploadList"], ["td", "Whether to show uploadList."], ["td", "Boolean"], ["td", "true"]], ["tr", ["td", "multiple"], ["td", "Whether to support selected multiple file. ", ["code", "IE10+"], " supported. You can select multiple files with CTRL holding down while multiple is set to be true"], ["td", "Boolean"], ["td", "false"]], ["tr", ["td", "accept"], ["td", "File types that can be accepted. See ", ["a", {
	    "title": null,
	    "href": "https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-accept"
	  }, "input accept Attribute"]], ["td", "String"], ["td", "-"]], ["tr", ["td", "beforeUpload"], ["td", "Hook function which will be executed before uploading. Uploading will be stopped with ", ["code", "false"], " or a rejected Promise returned. ", ["strong", "Warning：this function is not supported by old IE"], "。"], ["td", "(file, fileList) => ", ["code", "boolean | Promise"]], ["td", "-"]], ["tr", ["td", "customRequest"], ["td", "override for the default xhr behavior allowing for additional customization and ability to implement your own XMLHttpRequest"], ["td", "Function"], ["td", "-"]], ["tr", ["td", "onChange"], ["td", "A callback function, can be executed when uploading state is changing. See ", ["a", {
	    "title": null,
	    "href": "#onChange"
	  }, "onChange"]], ["td", "Function"], ["td", "-"]], ["tr", ["td", "listType"], ["td", "Built-in stylesheets, support for two types: ", ["code", "text"], " or ", ["code", "picture"]], ["td", "String"], ["td", "'text'"]], ["tr", ["td", "onPreview"], ["td", "A callback function, will be executed when file link is clicked."], ["td", "Function(file)"], ["td", "-"]], ["tr", ["td", "onRemove"], ["td", "A callback function, will be executed when removing file button is clicked"], ["td", "Function(file)"], ["td", "-"]], ["tr", ["td", "supportServerRender"], ["td", "Need to be turned on while the server side is rendering."], ["td", "Boolean"], ["td", "false"]], ["tr", ["td", "disabled"], ["td", "disable upload button"], ["td", "Boolean"], ["td", "false"]], ["tr", ["td", "withCredentials"], ["td", "ajax upload with cookie sent"], ["td", "Boolean"], ["td", "false"]]]], ["h3", "onChange"], ["blockquote", ["p", "The function will be called when uploading is in progress, completed or  failed"]], ["p", "When uploading state change, it returns:"], ["pre", {
	    "lang": "js",
