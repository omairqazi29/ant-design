...
/***/ function(module, exports) {
	...
	module.exports = {
	  "content": [
	    ...
	    [
	      "p",
	      "We provide some locale like English, Chinese, Russion, German, French and etc, all locale packages can be found in ",
	      [
	        "a",
	        {
	          "title": null,
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            "td",
	            "language package setting, you can find the packages in this path: ",
	            [
	              "code",
