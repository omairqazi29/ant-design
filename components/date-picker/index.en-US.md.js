...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  "api": ["section", ["h2", "API"], ["p", "There are three kinds of picker:"], ["ul", ["li", ["p", "DatePicker"]], ["li", ["p", "MonthPicker"]], ["li", ["p", "RangePicker"]]], ["p", ["strong", "Note:"], " Part of locale of DatePicker, MonthPicker, RangePicker is read from value. So, please set the locale of moment correctly."], ["pre", {
	    ...
	    "title": null,
	    "href": "http://momentjs.com/"
	  }, "moment.js"]], ["td", "String"], ["td", "\"YYYY-MM-DD\""]], ["tr", ["td", "onChange"], ["td", "a callback function, can be executed when the selected time is changing"], ["td", "function(date: moment, dateString: string)"], ["td", "-"]], ["tr", ["td", "open"], ["td", "open state of picker"], ["td", "bool"], ["td", "-"]], ["tr", ["td", "onOpenChange"], ["td", "a callback function, can be executed whether the popup calendar is popped up or closed"], ["td", "function(status)"], ["td", "-"]], ["tr", ["td", "showTime"], ["td", "to provide an additional time selection"], ["td", "Object/Boolean"], ["td", ["a", {
	    "title": null,
	    ...
	    "title": null,
	    "href": "/components/time-picker/#api"
	  }, "TimePicker Options"]]], ["tr", ["td", "disabledTime"], ["td", "to specify the time that cannot be selected"], ["td", "function(dates: ", "[moment, moment]", ", partial: ", ["code", "'start'|'end'"], ")"], ["td", "-"]]]], ["style", "\n.code-box-demo .ant-calendar-picker {\n  margin: 0 8px 12px 0;\n}\n"]]
	};
