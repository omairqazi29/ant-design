	...
	module.exports = {
	  ...
	  "api": [
	    ...
	    [
	      ...
	      " Part of locale of DatePicker, MonthPicker, RangePicker is read from value. So, please set the locale of moment correctly."
	    ],
	    [
	      "pre",
	      {
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            ...
	            ", are 32px and 22px respectively, while default size is 28px"
	          ],
	          [
	            "td",
	            "String"
