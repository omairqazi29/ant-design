	...
	module.exports = {
	  ...
	  "api": [
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            "td",
	            "The unique identifier of current notification"
	          ],
	          [
	            "td",
	            "String"
	        ...
	        [
	          ...
	          [
	            "td",
	            "Specify a function that will be called after clicking the default close button"
	          ],
	          [
	            "td",
	            "Function"
	        ...
	        [
	          ...
	          [
	            "td",
	            "A notification box is closed after 4.5s by default. When specifying ",
	            [
	              "code",
	              "duration"
	            ],
	    ...
	    [
	      ...
	      " method that can be used for specifying the default options. Once this method is used, all the notification boxes\nwill take into account these globally defined options before displaying."
	    ],
	    [
	      "ul",
	      [
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            "td",
	            "A duration to close notification automatically by default (unit: second)"
	          ],
	          [
	            "td",
	            "Number"
