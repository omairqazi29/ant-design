...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  "content": ["section", ["p", "具有数据收集、校验和提交功能的表单，包含复选框、单选框、输入框、下拉选择框等元素。"], ["h2", "表单"], ["p", "我们为 ", ["code", "form"], " 提供了以下两种排列方式："], ["ul", ["li", ["p", "水平排列：标签和表单控件水平排列；（默认）"]], ["li", ["p", "垂直排列：标签和表单控件上下垂直排列；"]], ["li", ["p", "行内排列：表单项水平行内排列。"]]], ["h2", "表单域"], ["p", "表单一定会包含表单域，表单域可以是输入控件，标准表单域，标签，下拉菜单，文本域等。"], ["p", "这里我们封装了表单域 ", ["code", "<Form.Item />"], " 。"], ["pre", {
	    "lang": "jsx",
	  ...
	  }, "更多"], "）"], ["td", "Function({ ", "[fieldname]", ": value }"]], ["tr", ["td", "setFields"], ["td", "设置一组输入控件的值与 Error。 ", ["a", {
	    "title": null,
