...
/***/ function(module, exports) {
	...
	module.exports = {
	  "content": [
	    ...
	    [
	      "p",
	      "A long list can be divided into several pages by ",
	      [
	        "code",
	        "Pagination"
	      ],
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          [
	            "td",
	            "default number of data per page"
	          ],
	          [
	            "td",
	            "number"
	        ...
	        [
	          ...
	          [
	            "td",
	            "a callback function, can be executed when ",
	            [
	              "code",
	              "pageSize"
	            ],
	        ...
	        [
	          ...
	          [
	            "td",
	            "determine whether you can jump to a page directly"
	          ],
	          [
	            "td",
	            "boolean"
