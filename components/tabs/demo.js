...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    'card-top': __webpack_require__(1673),
	    'card': __webpack_require__(1674),
	    'custom-add-trigger': __webpack_require__(1675),
	    'disabled': __webpack_require__(1676),
	    'editable-card': __webpack_require__(1677),
	    'extra': __webpack_require__(1678),
	    'icon': __webpack_require__(1679),
	    'position': __webpack_require__(1680),
	    'size': __webpack_require__(1681),
	    'slide': __webpack_require__(1682),
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _style4 = __webpack_require__(84);
	  ...
	  "preview": function jsonmlReactLoader() {
	    var TabPane = _tabs2.default.TabPane;var Demo = _react2.default.createClass({
	      ...
	      add: function add() {
	        ...
	        var activeKey = 'newTab' + this.newTabIndex++;panes.push({ title: 'New Tab', content: 'New Tab Pane', key: activeKey });this.setState({ panes: panes, activeKey: activeKey });
	      },
	...
	module.exports = {
	  ...
	  "preview": function jsonmlReactLoader() {
	    var TabPane = _tabs2.default.TabPane;var Demo = _react2.default.createClass({
	      ...
	      add: function add() {
	        var panes = this.state.panes;var activeKey = 'newTab' + this.newTabIndex++;
	        panes.push({ title: 'New Tab', content: 'Content of new Tab', key: activeKey });this.setState({ panes: panes, activeKey: activeKey });
	      },
	      remove: function remove(targetKey) {
	        var activeKey = this.state.activeKey;var lastIndex = void 0;this.state.panes.forEach(function (pane, i) {
	          if (pane.key === targetKey) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _style3 = __webpack_require__(31);
