...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  "content": ["section", ["p", "多选框。"], ["h2", "何时使用"], ["ul", ["li", ["p", "在一组可选项中进行多项选择时；"]], ["li", ["p", "单独使用可以表示两种状态之间的切换，和 ", ["code", "switch"], " 类似。区别在于切换 ", ["code", "switch"], " 会直接触发状态改变，而 ", ["code", "checkbox"], " 一般用于状态标记，需要和提交操作配合。"]]]],
	  "meta": {
	    "category": "Components",
	    "subtitle": "多选框",
	    "type": "Data Entry",
