...
module.exports = {
  "content": [
    ...
    [
      "p",
      "优秀的字体系统首先是要选择合适的字体家族。Ant Design 的字体家族中优先使用系统默认的界面字体，同时提供了一套利于屏显的备用字体库，来维护在不同平台以及浏览器的显示下，字体始终保持良好的易读性和可读性，体现了友好、稳定和专业的特性。此外，考虑到中后台产品常常会有大量的数字对比展示的诉求，我们单独将数字的字体定义为等宽的 Helvatica Neue，以便于提升数字间纵向比较时的阅读体验。"
    ],
    [
      "pre",
      {
        "lang": "css",
        "highlighted": "<span class=\"token property\">font-family</span><span class=\"token punctuation\">:</span> -apple-system, BlinkMacSystemFont, <span class=\"token string\">\"Segoe UI\"</span>, Roboto,\n             <span class=\"token string\">\"Helvetica Neue\"</span>, Helvetica, <span class=\"token string\">\"PingFang SC\"</span>, <span class=\"token string\">\"Hiragino Sans GB\"</span>, <span class=\"token string\">\"Microsoft YaHei\"</span>,\n             SimSun, sans-serif<span class=\"token punctuation\">;</span>"
      },
      [
        "code",
    ...
    [
      "p",
      "另外，在中后台系统中，数字经常需要进行纵向对比展示，我们单独将数字的字体设置为 ",
      [
        "code",
        "Helvetica Neue"
      ],
    ...
    [
      ...
      [
        ...
        [
          ...
          {
            "title": null,
            "href": "http://stackoverflow.com/questions/13611420/set-a-font-specifically-for-all-numbers-on-the-page"
          },
          "http://stackoverflow.com/questions/13611420/set-a-font-specifically-for-all-numbers-on-the-page"
        ]
      ]
    ],
    [
    ...
    [
      ...
      [
        ...
        [
          ...
          "在视觉展现上能够用尽量少的样式去实现设计目的。避免毫无意义的使用大量字阶、颜色、自重强调视觉重点或对比关系。"
        ]
      ],
      [
        "li",
