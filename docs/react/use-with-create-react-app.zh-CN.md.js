...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  "content": ["article", {}, ["h2", "安装和初始化"], ["p", "我们需要在命令行中安装 create-react-app 工具。"], ["pre", {
	    "lang": "bash",
	    "highlighted": "$ <span class=\"token function\">npm</span> <span class=\"token function\">install</span> -g create-react-app"
	  }, ["code", "$ npm install -g create-react-app"]], ["p", "然后新建一个项目。"], ["pre", {
	    "lang": "bash",
	    "highlighted": "$ USE_YARN<span class=\"token operator\">=</span>no create-react-app antd-demo"
	  }, ["code", "$ USE_YARN=no create-react-app antd-demo"]], ["p", "工具会自动初始化一个脚手架并安装 React 项目的各种必要依赖，如果在过程中出现网络问题，请尝试配置代理或使用其他 npm registry。"], ["p", "然后我们进入项目并启动。"], ["pre", {
	    "lang": "bash",
	    "highlighted": "$ <span class=\"token function\">cd</span> antd-demo\n$ <span class=\"token function\">npm</span> start"
	  }, ["code", "$ cd antd-demo\n$ npm start"]], ["p", "此时浏览器会访问 ", ["a", {
	    "title": null,
	  ...
	  }, ["code", "├── README.md\n├── package.json\n├── public\n│   ├── favicon.ico\n│   └── index.html\n├── src\n│   ├── App.css\n│   ├── App.js\n│   ├── App.test.js\n│   ├── index.css\n│   ├── index.js\n│   └── logo.svg\n└── yarn.lock"]], ["p", "现在从 npm 安装并引入 antd。"], ["pre", {
	    "lang": "bash",
	    "highlighted": "$ <span class=\"token function\">npm</span> <span class=\"token function\">install</span> antd --save"
	  }, ["code", "$ npm install antd --save"]], ["p", "修改 ", ["code", "src/App.js"], "，引入 antd 的按钮组件。"], ["pre", {
	    "lang": "jsx",
	  ...
	  }, "官方文档"], "。"], ["h2", "高级配置"], ["p", "我们现在已经把组件成功运行起来了，但是在实际开发过程中还有很多问题，例如上面的例子实际上加载了全部的 antd 组件的代码（对前端性能是个隐患）。"], ["blockquote", ["p", "你会在控制台看到如下警告。"]], ["p", ["img", {
	    "title": null,
	  ...
	  }, ["code", "$ npm run eject"]], ["h3", "按需加载"], ["p", "现在可以安装 ", ["a", {
	    "title": null,
	    "href": "https://github.com/ant-design/babel-plugin-import"
	  }, "babel-plugin-import"], " 并修改 ", ["code", "src/webconfig.dev.js"], " 文件。"], ["pre", {
	    "lang": "bash",
	  ...
	  }, ["code", "// Process JS with Babel.\n{\n  test: /\\.(js|jsx)$/,\n  include: paths.appSrc,\n  loader: 'babel',\n  query: {\n+   plugins: [\n+     ['import', [{ libraryName: \"antd\", style: 'css' }]],\n+   ],\n    // This is a feature of `babel-loader` for webpack (not Babel itself).\n    // It enables caching results in ./node_modules/.cache/babel-loader/\n    // directory for faster rebuilds.\n    cacheDirectory: true\n  }\n},"]], ["p", "然后移除前面在 ", ["code", "src/App.css"], " 里全量添加的 ", ["code", "@import '~antd/dist/antd.css';"], " 样式代码，现在 babel-plugin-import 会按需加载样式。"], ["p", "最后重启 ", ["code", "npm start"], " 访问页面，此时上面的警告信息应该没了，antd 组件的 js 和 css 代码都会按需加载。"], ["h3", "自定义主题"], ["p", "按照 ", ["a", {
	    "title": null,
	    "href": "/docs/react/customize-theme"
	  }, "配置主题"], " 的要求，自定义主题需要用到 less 变量覆盖功能，因此首先我们需要引入 ", ["a", {
	    "title": null,
	    "href": "https://github.com/webpack/less-loader"
	  }, "less-loader"], " 来加载 less 样式，同时修改 ", ["code", "src/webconfig.dev.js"], " 文件。"], ["pre", {
	    "lang": "bash",
	    ...
	    "title": null,
	    "href": "/docs/react/customize-theme"
	  }, "配置主题"], " 文档。"], ["p", "修改后重启 ", ["code", "npm start"], "，如果看到一个绿色的按钮就说明配置成功了。"], ["hr"], ["p", "以上是在 create-react-app 中使用 antd 的相关实践，你也可以借鉴此文的做法在自己的 webpack 工作流中使用 antd，更多 webpack 配置可参考 ", ["a", {
	    "title": null,
	    "href": "https://github.com/ant-tool/atool-build/blob/master/src/getWebpackCommonConfig.js"
	  }, "atool-build"], "。"], ["p", "本例源码可见：", ["a", {
	    "title": null,
