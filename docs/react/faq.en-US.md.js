...
module.exports = {
  "content": [
    ...
    [
      ...
      [
        ...
        "the LICENSE of ant-design"
      ],
      " is MIT. So, you can try to implement it with ant-design's ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      "(etc...) only works in first render. It is a specification of React, please read ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      " so you don't need to deploy iconfont locally any more!"
    ],
    [
      "h3",
    ...
    [
      ...
      "'s version which you use, and make sure that you pass value with correct type to ",
      [
        "code",
        "antd"
      ],
  ...
  "description": [
    ...
    [
      "p",
      "Search in the questions about React first: ",
      [
        "a",
        {
          "title": null,
