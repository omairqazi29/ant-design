...
module.exports = {
  "content": [
    ...
    [
      ...
      " is a demo only scaffold tool. If you want to create real world projects, ",
      [
        "a",
        {
          "title": null,
    ...
    [
      "p",
      "If you see logs like below screenshot, you might be importing all components by writing ",
      [
        "code",
    ...
    [
      ...
      {
        "lang": "jsx",
        "highlighted": "<span class=\"token keyword\">import</span> Button <span class=\"token keyword\">from</span> <span class=\"token string\">'antd/lib/button'</span><span class=\"token punctuation\">;</span>\n<span class=\"token keyword\">import</span> <span class=\"token string\">'antd/lib/button/style'</span><span class=\"token punctuation\">;</span> <span class=\"token comment\" spellcheck=\"true\">// or antd/lib/button/style/css for css format file</span>"
      },
      [
        "code",
    ...
    [
      ...
      [
        ...
        [
          ...
          " has been integrated into our work flow."
        ]
      ]
    ]
  ],
  ...
  "description": [
    ...
    [
      ...
      " for programmers. Make sure that you had installed ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      [
        "a",
        {
          ...
          "title": "Standard Development Flow"
        },
        "Standard Development Flow"
      ]
    ],
