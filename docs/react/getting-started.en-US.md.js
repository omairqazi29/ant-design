...
/***/ function(module, exports) {
	...
	module.exports = {
	  "content": [
	    ...
	    [
	      "p",
	      "Before delving into Ant Design React, a good knowledge of ",
	      [
	        "a",
	        {
	          "title": null,
	    ...
	    [
	      ...
	      [
	        "p",
	        "Please make sure that you had installed ",
	        [
	          "a",
	          {
	            "title": null,
	    ...
	    [
	      ...
	      " after a project is created. If it fails, you can run ",
	      [
	        "code",
	        "npm install"
	      ],
	    ...
	    [
	      "p",
	      "By default, besides the scaffolding needed to start the development, a fully working Todo application is created.\nYou may study this example later. For now, just follow this guide in order to get some experience working with the result of ",
	      [
	        "code",
	        "antd-init"
	      ],
	    ...
	    [
	      "p",
	      "Entry files will be built and generated in ",
	      [
	        "code",
	        "dist"
	      ],
	      " directory, then we can deploy it to different environments."
	    ],
	    [
	      "blockquote",
	      [
	    ...
	    [
	      ...
	      " and other polyfills for IE browsers. If you are using babel, we strongly recommend to use ",
	      [
	        "a",
	        {
	          "title": null,
	    ...
	    [
	      ...
	      " doesn't support IE8. You can refer to this ",
	      [
	        "a",
	        {
	          "title": null,
	    ...
	    [
	      "p",
	      "If you want to customize your work flow, we recommend to use ",
	      [
	        "a",
	        {
	          "title": null,
	    ...
	    [
	      ...
	      " available in React ecosystem. If you encounter problems, you can use our ",
	      [
	        "a",
	        {
	          "title": null,
	    ...
	    [
	      "p",
	      "If you see a log like below screenshot, you might import all components by writing ",
	      [
	        "code",
	        "import { Button } from 'antd';"
	      ],
	      ", this will affect your app's network perfermance."
	    ],
	    [
	      "blockquote",
	      [
	    ...
	    [
	      ...
	      ", which can convert the following code to the 'antd/lib/xxx' way:"
	    ],
	    [
	      "pre",
	      {
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          " has been integrated in our work flow."
	        ]
	      ]
	    ]
	  ],
