...
/***/ function(module, exports) {
	...
	module.exports = {
	  "content": [
	    ...
	    [
	      "p",
	      "Install dva-cli with npm, and make sure the version is larger then ",
	      [
	        "code",
	        "0.7.0"
	      ],
	    ...
	    [
	      "p",
	      "After installed dva-cli, you can have access to the ",
	      [
	        "code",
	        "dva"
	      ],
	      " command in terminal. Now, create a new application with ",
	      [
	        "code",
	        "dva new"
	      ],
	    ...
	    [
	      ...
	      " in your browser, you will see dva welcome page."
	    ],
	    [
	      "h2",
	      "Integrate antd"
	    ...
	    [
	      ...
	      " is used to automatically import scripts and stylesheets from antd in demand. See ",
	      [
	        "a",
	        {
	          "title": null,
	    ...
	    [
	      ...
	      [
	        "p",
	        "Notice: dva-cli's build and server is bases on roadhog, view ",
	        [
	          "a",
	          {
	            "title": null,
	    ...
	    [
	      ...
	      [
	        ...
	        [
	          ...
	          " represent the key on global state"
	        ]
	      ],
	      [
	        "li",
	        [
	          ...
	          " is the initial value, here is an empty array"
	        ]
	      ],
	      [
	        "li",
	  ...
	  "description": [
	    ...
	    [
	      ...
	      " is a React and redux based, lightweight and elm-style framework, which supports side effects, hot module replacement, dynamic on demand, react-native, SSR. And it has been widely used in production environment."
	    ],
	    [
	      "p",
