...
module.exports = {
  "content": [
    ...
    [
      "p",
      "Install dva-cli with npm, and make sure the version is later than ",
      [
        "code",
        "0.9.1"
      ],
    ...
    [
      "p",
      "After you have installed dva-cli, you can have access to the ",
      [
        "code",
        "dva"
      ],
      ...
      [
        ...
        {
          "title": null,
          "href": "http://stackoverflow.com/questions/15054388/global-node-modules-not-installing-correctly-command-not-found"
        },
        "can't access?"
      ],
      "). Now, create a new application with ",
      [
        "code",
        "dva new"
      ],
    ...
    [
      ...
      " directory, that contains the project directories and files, and provides a development server, build script, mock service, proxy server and so on."
    ],
    [
      "p",
      "Then ",
    ...
    [
      ...
      " in your browser, you will see the dva welcome page."
    ],
    [
      "h2",
      "Integrate antd"
    ...
    [
      ...
      " is used to automatically import scripts and stylesheets from antd on demand. See ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      [
        "p",
        "Notice: dva-cli's build and dev is based on roadhog, view ",
        [
          "a",
          {
            "title": null,
    ...
    [
      "p",
      "Add routing information to router, edit ",
      [
        "code",
        "router.js"
      ],
    ...
    [
      ...
      " in your browser, you should be able to see the ",
      [
        "code",
        "<h2>"
      ],
    ...
    [
      "p",
      "Then don't forget to require it in ",
      [
        "code",
        "index.js"
      ],
    ...
    [
      ...
      {
        "lang": "diff",
        "highlighted": "// 3. Model\n<span class=\"token inserted\">+ app.model(require('./models/products').default);</span>"
      },
      [
        "code",
    ...
    [
      ...
      " method. If you are familiar with redux, this ",
      [
        "code",
        "connect"
      ],
    ...
    [
      ...
      [
        ...
        [
          "p",
          "If your project is created with ",
          [
            "a",
            {
              "title": null,
  ...
  "description": [
    ...
    [
      ...
      " is a React and redux based, lightweight and elm-style framework, which supports side effects, hot module replacement, dynamic on demand, react-native, and SSR. It has been widely used in production environments."
    ],
    [
      "p",
