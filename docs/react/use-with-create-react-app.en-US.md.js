...
/***/ function(module, exports) {
	...
	module.exports = {
	  "content": [
	    ...
	    [
	      "p",
	      "Ok, you now see a blue primary button displaying in page now, next you can choose any components of ",
	      [
	        "code",
	        "antd"
	      ],
	      " to develop your application. Visit other workflow of ",
	      [
	        "code",
	        "create-react-app"
	      ],
	    ...
	    [
	      "p",
	      "So it is necessary to customize the default webpack config. We can achieve that by using ",
	      [
	        "code",
	        "eject"
	      ],
	    ...
	    [
	      ...
	      "). After eject all config files to antd-demo, we allowed to install it and modify ",
	      [
	        "code",
	    ...
	    [
	      ...
	      [
	        ...
	        " file after config eject, so we have to put the babel option into ",
	        [
	          "code",
	          "webpack.config.js"
	        ],
	    ...
	    [
	      ...
	      " and visit demo page, you should find that the above warning message would be gone which prove the ",
	      [
	        "code",
	        "import on demand"
	      ],
	      " config is effective now."
	    ],
	    [
	      "h3",
	      "Customize Theme"
	    ...
	    [
	      ...
	      " here, you can see a green button rendered on the page after reboot start server."
	    ],
	    [
	      "hr"
	    ],
	    [
	      "p",
	      "Finally, we use antd with create-react-app successfully, you can learn these practice for your own webpack workflow too, and find more webpack config in the ",
	      [
	        "a",
	        {
	          "title": null,
	    ...
	    [
	      "p",
	      "Source code about this article：",
	      [
	        "a",
	        {
	          "title": null,
	  ...
	  "description": [
	    ...
	    [
	      ...
	      " is one of best React application development tool, we are going to use ",
	      [
	        "code",
	        "antd"
	      ],
