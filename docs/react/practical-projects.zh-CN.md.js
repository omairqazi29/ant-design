...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  }, "http://localhost:8000"], " ，你会看到 dva 的欢迎界面。"], ["h2", "使用 antd"], ["p", "通过 npm 安装 ", ["code", "antd"], " 和 ", ["code", "babel-plugin-import"], " 。", ["code", "babel-plugin-import"], " 是用来按需加载 antd 的脚本和样式的，详见 ", ["a", {
	    "title": null,
	  ...
	  }, "http://localhost:8000/#/products"], " ，你应该能看到前面定义的 ", ["code", "<h2>"], " 标签。"], ["h2", "编写 UI Component"], ["p", "随着应用的发展，你会需要在多个页面分享 UI 元素 (或在一个页面使用多次)，在 dva 里你可以把这部分抽成 component 。"], ["p", "我们来编写一个 ", ["code", "ProductList"], " component，这样就能在不同的地方显示产品列表了。"], ["p", "新建 ", ["code", "components/ProductList.js"], " 文件："], ["pre", {
	    "lang": "javascript",
