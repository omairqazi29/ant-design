...
module.exports = {
  "content": [
    ...
    [
      ...
      " 命令会打包所有的资源，包含 JavaScript, CSS, web fonts, images, html 等。然后你可以在 ",
      [
        "code",
        "dist/"
      ],
    ...
    [
      ...
      [
        ...
        [
          "p",
          "如果你基于 dva-cli 创建项目，最好了解他的 ",
          [
            "a",
            {
              "title": null,
              "href": "https://github.com/sorrycc/roadhog/blob/master/README_zh-cn.md#配置"
            },
            "配置方式"
          ]
        ]
  ...
  "description": [
    ...
    [
      ...
      " 是一个基于 React 和 Redux 的轻量应用框架，概念来自 elm，支持 side effects、热替换、动态加载、react-native、SSR 等，已在生产环境广泛应用。"
    ],
    [
      "p",
