...
module.exports = {
  "content": [
    ...
    [
      "p",
      "This approach is available only when using ",
      [
        "a",
        {
          "title": null,
      ...
      ". If you choose other boilerplates, you can write a webpack config about ",
      [
        "a",
        {
          "title": null,
    ...
    [
      ...
      [
        ...
        [
          ...
          ", the value must be contained in quotes like ",
          [
            "code",
