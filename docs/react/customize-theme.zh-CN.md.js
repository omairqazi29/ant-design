...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  }, "less-loader"], " 的 ", ["code", "modifyVars"], " 配置来覆盖原来的样式变量。"], ["p", "注意："], ["ul", ["li", ["p", "样式必须加载 less 格式。如果您使用了 ", ["code", "babel-plugin-import"], "，请将 style 属性配置为 ", ["code", "true"], "。"]], ["li", ["p", "如果要覆盖 ", ["code", "@icon-url"], " 变量，内容需要包括引号 ", ["code", "\"@icon-url\": \"'your-icon-font-path'\""], "（", ["a", {
	    "title": null,
	    "href": "https://github.com/visvadw/dvajs-user-dashboard/pull/2"
	  }, "修正示例"], "）。"]]], ["h3", "2) less"], ["p", "用 less 文件进行变量覆盖。"], ["p", "建立一个单独的 ", ["code", "less"], " 文件如下，再引入这个文件。"], ["pre", {
	    "lang": "css",
